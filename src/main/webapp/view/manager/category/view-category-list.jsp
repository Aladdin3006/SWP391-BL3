                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text"
                               ...
                               maxlength="100"
                               value="${categoryName}">
                        <small class="text-danger error-text" id="nameError">
...
<script>
    ...
    document.getElementById("addCategoryForm").addEventListener("submit", function (e) {
        ...
        if (isEmpty(name)) {
            ...
            showError("nameError", "Category name must not exceed 100 characters.");
            hasError = true;
        }
        ...
        if (isEmpty(desc)) {
            ...
            showError("descError", "Description must not exceed 255 characters.");
            hasError = true;
        }
