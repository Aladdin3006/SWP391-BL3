            ...
            <c:if test="${not empty selectedTicket}">
                <div class="status-warning" id="statusWarning">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h5 class="mb-1">Creating as COMPLETED</h5>
                            <p class="mb-0">This will update warehouse inventory and create product change records.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body p-4">
                        <form action="add" method="POST" id="transferForm">
                            <input type="hidden" name="requestTransferId" value="${selectedTicket.id}">
                            <input type="hidden" id="transferType" value="${selectedTicket.type}">
                            ...
                            <div class="row g-3 mb-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="status" id="statusSelect" class="form-select" onchange="checkStatus()">
                            ...
                            <div class="d-flex justify-content-end mt-3">
                                <button type="button" id="submitBtn" onclick="submitForm()" class="btn btn-success btn-lg px-5">
...
<script>
    function checkStatus() {
        ...
        if (status === 'Completed') {
            ...
            submitBtn.innerHTML = '<i class="fas fa-check-circle me-2"></i> Save & Update Warehouse';

            let typeMessage = '';
            if (transferType === 'Import') {
                typeMessage = ' (Stock will INCREASE)';
                submitBtn.classList.remove('btn-success');
                submitBtn.classList.add('btn-warning');
            } else if (transferType === 'Export') {
                typeMessage = ' (Stock will DECREASE)';
                submitBtn.classList.remove('btn-success');
                submitBtn.classList.add('btn-danger');
            }

            submitBtn.innerHTML = '<i class="fas fa-check-circle me-2"></i> Save & Update Warehouse' + typeMessage;
        } else {
            warningDiv.style.display = 'none';
            submitBtn.innerHTML = '<i class="fas fa-save me-2"></i> Save Ticket';
    ...
    function submitForm() {
        ...
        if (status === 'Completed') {
            let message = 'Are you sure you want to create this transfer as COMPLETED? This will update warehouse inventory and create product change records.';
